...
function chromosome (objects,DNA_ID)
{
	...
	$.each( objects, function( i, object ) {
		chromosomeDiv = chromosomeDiv + '<div class="col-md-5 chromosome" style="background-color:' + object.color + '"><input type="radio" name="radio-'+ DNA_ID +'-' + object.id + '" value="1"> <a href="#" name="soundData-'+ DNA_ID +'-' + object.id + '" class="btn btn-default btn-xs chromosome-play">Play</a><input type="radio" class="mutate-radio" name="radio-'+ DNA_ID +'-' + object.id + '" value="2"><input type="hidden" id="soundData-'+ DNA_ID +'-' + object.id + '" name="soundData-'+ DNA_ID +'-' + object.id + '" value="'+ object.soundData +'"></div>';
		if(i % 2 !== 0)
		{
