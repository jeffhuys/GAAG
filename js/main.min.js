...
$( document ).ready(function() {
    ...
    $( '.generate').on( "click",function() {
		...
		var newDNAPopulation = combineDNA(retrieveFromHiddenStorage(DNAArrayToSave), parseInt($('#amtDNAObjects').val()), parseInt($('#amtChromosomes').val()), parseInt($('#chainProbability').val()), 1);
