...
function chromosome (objects,DNA_ID)
{
	...
	$.each( objects, function( i, object ) {
		chromosomeDiv = chromosomeDiv + '<div class="col-md-5 chromosome" style="background-color:' + object.color + '"><input type="radio" id="radio-'+ DNA_ID +'-' + object.id + '" name="radio-'+ DNA_ID +'-' + object.id + '" value="1"> <input type="radio" class="mutate-radio" id="radio-'+ DNA_ID +'-' + object.id + '" name="radio-'+ DNA_ID +'-' + object.id + '" value="2"><div class="btn-group btn-group-justified"><a href="#" name="soundData-'+ DNA_ID +'-' + object.id + '" class="btn btn-default btn-xs chromosome-play">Play</a><a href="'+ download(object.soundData) +'" name="soundData-'+ DNA_ID +'-' + object.id + '" class="btn btn-default btn-xs chromosome-download" download="sound.wav">Download</a></div><input type="hidden" id="soundData-'+ DNA_ID +'-' + object.id + '" name="soundData-'+ DNA_ID +'-' + object.id + '" value="'+ object.soundData +'"></div>';
		if(i % 2 !== 0)
		{
